...
String valueToQuotedString(const char* value, size_t length) { return valueToQuotedStringN(value, length); }
...
void FastWriter::writeValue(const Value& value) {
    switch (value.type()) {
        ...
        case stringValue: {
            ...
            if (ok) document_ += valueToQuotedStringN(str, static_cast<size_t>(end - str));
            break;
        }
        case booleanValue:
